...
describe('resolveFields', (it) => {
  ...
  it('should add fields from the override', (t) => {
    ...
    t.deepEqual(resolveFields(['_id', 'users'], fields, {another: 1}),
      {'_id': 0, 'users.id': 1, 'users.email': 1, 'users.services.google.token': 1, another: 1});
  });
});
